/**
  ...
  *          Screen on STM32H745I_DISCO board.
  ******************************************************************************
  * @attention
  *
...
--------------------------
   - This driver is used to drive the FT5336 touch screen module
     mounted over TFT-LCD on the STM32H745I-DISCO board.
...
/** @defgroup STM32H745I_DISCO_TS TS
  * @{
  */

/** @defgroup STM32H745I_DISCO_TS_Private_Types_Definitions Private Types Definitions
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_TS_Private_Defines Private Types Defines
  * @{
  */
/**
  * @}
...
/** @defgroup STM32H745I_DISCO_TS_Private_Macros Private Macros
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32H745I_DISCO_TS_Private_Function_Prototypes Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_TS_Privates_Variables Privates Variables
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_TS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32H745I_DISCO_TS_Exported_Functions Exported Functions
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32H745I_DISCO_TS_Private_Functions Private Functions
  * @{
  */
/**
...
int32_t GT911_Probe(uint32_t Instance)
{
  ...
  const uint16_t addresses[2] = {TS_I2C_ADDRESS_GT, TS_I2C_ADDRESS_BACK};
  ...
  while (addressIndex < 2)
  {
    ...
    IOCtx.Address     = addresses[addressIndex];
    ...
    /* Switch to the backup address if the first attempt failed */
    addressIndex++;
  }
